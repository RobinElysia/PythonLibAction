...
with open(r'D:\code\python\LearnPyLib\ProjectPractice\3_cleaned.txt', 'w', encoding='utf-8') as f:
...
token = AutoTokenizer.from_pretrained(r"D:\model\Em\bloom") # 我的模型在本地，你们需要更改
model = AutoModel.from_pretrained(r"D:\model\Em\bloom")
model.eval()
